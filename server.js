...
const serverHandler = (req, res) => {
  ...
  // ========================================
  // ENDPOINT: /api/pagar
  // Integração direta com IronPay (Gateway Personalizado)
  // ========================================
      ...
      try {
        ...
        if (isMercadoPago) {
          ...
          requestData = {
            ...
            offer_hash: offerHash || '7becb', // Obrigatório - hash da oferta
            payment_method: 'pix',
            ...
            cart: cart || [
              {
                product_hash: productHash || '7tjdfkshdv', // Obrigatório - hash do produto
